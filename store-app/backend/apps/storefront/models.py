...
class WidgetType(models.TextChoices):
    ...
    DISCOVERY_BOX = "discovery_box", "بانر باقة عينات التجربة"
    TRUST_BADGES = "trust_badges", "شريط مزايا وضمانات المتجر"
    FREE_SHIPPING_BAR = "free_shipping_bar", "شريط حافز الشحن المجاني"
    GIFT_WRAP_UPSELL = "gift_wrap_upsell", "جناح التغليف الفاخر وبطاقة الإهداء"
