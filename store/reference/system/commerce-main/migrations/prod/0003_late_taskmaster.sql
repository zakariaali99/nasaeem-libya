CREATE TABLE "partner_apps" (
	...
	"mode" varchar(20) DEFAULT 'test' NOT NULL,
...
ALTER TABLE "widgets" ADD COLUMN "targeting" json;--> statement-breakpoint
...
CREATE UNIQUE INDEX "uidx_wallet_txn_idempotency" ON "wallet_transactions" USING btree ("wallet_account_id","idempotency_key") WHERE "wallet_transactions"."idempotency_key" IS NOT NULL;--> statement-breakpoint
